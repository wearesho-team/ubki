...
class ContactTypeTest extends ReferenceTestCase
{
    public function testMobile(): void
    {
        ...
        $this->assertEquals(
            ContactType::MOBILE(static::DESCRIPTION),
            $this->fakeReference
        );
    }
    ...
    public function testHome(): void
    {
        ...
        $this->assertEquals(
            ContactType::HOME(static::DESCRIPTION),
            $this->fakeReference
        );
    }
    ...
    public function testWork(): void
    {
        ...
        $this->assertEquals(
            ContactType::WORK(static::DESCRIPTION),
            $this->fakeReference
        );
    }
    ...
    public function testFax(): void
    {
        ...
        $this->assertEquals(
            ContactType::FAX(static::DESCRIPTION),
            $this->fakeReference
        );
    }
    ...
    public function testEmail(): void
    {
        ...
        $this->assertEquals(
            ContactType::EMAIL(static::DESCRIPTION),
            $this->fakeReference
        );
    }
}
