...
<tech>
    ...
    <sentdatainfo reqid="IN#1231231233" state="er">
        ...
        $this->assertEquals('IN#1231231233', $response->getUbkiId());
        $this->assertEquals('er', $response->getStatus());
        $this->assertEmpty($response->getInternalError());
        $this->assertEmpty($response->getInternalMessage());
        $this->assertEquals(
