 ...
 * @coversDefaultClass \Wearesho\Bobra\Ubki\Push\Export\DataDocument
 * @internal
 */
class DataDocumentTest extends TestCase
{
    ...
    /** @var Ubki\Push\Export\DataDocument */
    protected $fakeDataDocument;

    protected function setUp(): void
    {
        $this->fakeDataDocument = new Ubki\Push\Export\DataDocument(
    ...
    public function testJsonSerialize(): void
    {
        $this->assertArraySubset(
            [
                'identification' => new Ubki\Data\Blocks\Identification(
                    new Ubki\Data\Elements\Credential(
                        Ubki\Dictionaries\Language::RUS(),
                        static::NAME,
                        static::PATRONYMIC,
