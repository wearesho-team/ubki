 ...
 * @coversDefaultClass Pull\Service
 * @internal
 */
class ServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        putenv('UBKI_PULL_MODE=' . Authorization\ConfigInterface::MODE_TEST);
        putenv('UBKI_AUTH_URL=' . Authorization\ConfigInterface::TEST_AUTH_URL);
        $this->fakeConfig = new Pull\EnvironmentConfig();
...
<ubkidata>
    ...
    <comp id="18" descr="Претензійна робота">
        ...
        $this->fakeAuthProvider = new Authorization\CacheProvider(
            new SimpleCache\Cache(new SimpleCache\Drivers\MemoryCacheDriver()),
            $client,
            $this->logger
        );
        $this->fakeService = new Pull\Service(
            $this->fakeConfig,
        ...
        $requestResponsePair = $this->fakeService->send(new Pull\Request(
            new RequestData(
...
<doc><ubki sessid="A1F593950A8F4562AE5A5DB1914D658A"><req_envelope><req_xml>PHJlcXVlc3QgcmVxdHlwZT0iMDkiIHJlcXJlYXNvbj0iNSIgcmVxZGF0ZT0iMjAxOC0wMy0xMiI+CiAgPGkgcmVxbG5nPSIxIj4KICAgIDxpZGVudCBva3BvPSJ0ZXN0SW5uIi8+CiAgICA8bXZkLz4KICAgIDxicGhvbmUgcGhvbmU9IiIvPgogIDwvaT4KPC9yZXF1ZXN0Pg==</req_xml></req_envelope></ubki></doc>', // phpcs:ignore
