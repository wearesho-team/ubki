...
class AddressTest extends TestCase
{
    ...
    public function testJsonSerialize(): void
    {
        $this->assertArraySubset(
            [
                Interfaces\Address::TYPE => Dictionaries\AddressType::REGISTRATION(static::DESCRIPTION),
                Interfaces\Address::CREATED_AT => Carbon::parse(static::CREATED_AT),
                Interfaces\Address::LANGUAGE => Dictionaries\Language::RUS(static::DESCRIPTION),
                ...
                Interfaces\Address::CITY_TYPE => Dictionaries\CityType::SETTLEMENT(static::DESCRIPTION),
            ],
