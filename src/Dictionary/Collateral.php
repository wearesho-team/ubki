 ...
 *
 * @method static Collateral LEGAL(string $description = \null)
 * @method static Collateral INDIVIDUAL(string $description = \null)
 * @method static Collateral CABINET_MINISTERS_GUARANTEES(string $description = \null)
 * @method static Collateral NATIONAL_BANK_GUARANTEES(string $description = \null)
 * @method static Collateral INTERNATIONAL_BANKS_GUARANTEES(string $description = \null)
 * @method static Collateral OTHER_BANKS_GUARANTEE(string $description = \null)
 * @method static Collateral RIGHT_PROPERTY_TO_CASH_DEPOSITS(string $description = \null)
 * @method static Collateral BANKS_AND_COUNTRY_GUARANTEE_WITH_RATE_A(string $description = \null)
 * @method static Collateral RIGHT_PROPERTY_TO_CASH_PLACED_ON_DEPOSIT(string $description = \null)
 * @method static Collateral SECURITIES_ISSUED_BY_NBU(string $description = \null)
 * @method static Collateral BONDS_OF_STATE_MORTGAGE_INSTITUTION(string $description = \null)
 * @method static Collateral BANK_METALS(string $description = \null)
 * @method static Collateral PRECIOUS_METALS(string $description = \null)
 * @method static Collateral GOVERNMENT_SECURITIES(string $description = \null)
 * @method static Collateral NON_GOVERNMENT_SECURITIES(string $description = \null)
 * @method static Collateral REAL_ESTATE(string $description = \null)
 * @method static Collateral PROPERTY_RIGHTS_TO_FUTURE_REAL_ESTATE(string $description = \null)
 * @method static Collateral FINISHED_PRODUCTS(string $description = \null)
 * @method static Collateral STOCK_IN_TRADE(string $description = \null)
 * @method static Collateral MOTOR_TRANSPORT(string $description = \null)
 * @method static Collateral OTHER_MOVABLE_STATE(string $description = \null)
 * @method static Collateral OTHER_REAL_ESTATE(string $description = \null)
 * @method static Collateral PROPERTY_RIGHTS_TO_OTHER_COLLATERAL_OBJECTS(string $description = \null)
 * @method static Collateral OTHER_TYPES_OF_COLLATERAL(string $description = \null)
 * @method static Collateral GUARANTEE(string $description = \null)
 * @method static Collateral LIGHT_VEHICLES(string $description = \null)
 * @method static Collateral MONEY_COVER(string $description = \null)
 * @method static Collateral REAL_ESTATE_EXCEPT_FOR_HOUSING(string $description = \null)
 * @method static Collateral TRANSPORT_VEHICLES_EXCEPT_LIGHT_CARS(string $description = \null)
 * @method static Collateral MORTGAGE_BONDS(string $description = \null)
 * @method static Collateral SEVERAL_COLLATERAL(string $description = \null)
 * @method static Collateral SEVERAL_SECURITY(string $description = \null)
 * @method static Collateral SEVERAL_SECURITY_REAL_ESTATE_OF_HOUSING(string $description = \null)
 * @method static Collateral SEVERAL_COLLATERAL_WITH_LARGEST_REAL_ESTATE(string $description = \null)
 * @method static Collateral SEVERAL_COLLATERAL_WITH_FUTURE_LARGEST_REAL_ESTATE(string $description = \null)
 * @method static Collateral SEVERAL_COLLATERAL_MORTGAGE(string $description = \null)
 * @method static Collateral INTEGRAL_PROPERTY_COMPLEX_OBJECT(string $description = \null)
 * @method static Collateral EQUIPMENT(string $description = \null)
 * @method static Collateral SECURITIES_THAT_ENTERED_IN_EXCHANGE_REGISTER(string $description = \null)
 * @method static Collateral SECURITIES_ISSUED_BY_LOCAL_AUTHORITIES(string $description = \null)
 * @method static Collateral INVESTMENT_CERTIFICATES(string $description = \null)
 * @method static Collateral BIOLOGICAL_ASSETS(string $description = \null)
 * @method static Collateral PROPERTY_RIGHTS_PROPERTY_THAT_WILL_BELONG_NON_HOUSING_FUND(string $description = \null)
 * @method static Collateral GOVERNMENT_SECURITIES_ON_REPO_TRANSACTIONS(string $description = \null)
 * @method static Collateral MORTGAGE_BONDS_ISSUED_BY_FINANCIAL_INSTITUTION(string $description = \null)
 * @method static Collateral NOMINAL_SAVINGS(string $description = \null)
 * @method static Collateral SECURED_CASH_BANKS_GUARANTEES(string $description = \null)
 * @method static Collateral GOVERNMENT_COUNTRIES_GUARANTEES_WITH_RATING_A(string $description = \null)
 * @method static Collateral BANKS_GUARANTEES_WITH_CREDIT_RATING_A(string $description = \null)
 * @method static Collateral INTERNATIONAL_MULTILATERAL_BANKS_GUARANTEES(string $description = \null)
 * @method static Collateral GOVERNMENT_COUNTRIES_GUARANTEES_WITH_RATING_BBB(string $description = \null)
 * @method static Collateral BANKS_GUARANTEE_WITH_CREDIT_RATING_NOT_LOWER_BBB(string $description = \null)
 * @method static Collateral WITHOUT_COLLATERAL(string $description = \null)
 * @method static Collateral PLEDGE_OF_LAND(string $description = \null)
 */
