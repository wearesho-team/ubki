 ...
 *
 * @method static CompromisedPhone SCAMMER(string $description = \null)
 * @method static CompromisedPhone PAYPHONE(string $description = \null)
 * @method static CompromisedPhone FRICKER(string $description = \null)
 *
